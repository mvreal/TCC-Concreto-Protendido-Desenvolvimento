...
let arrayInputs = [...document.querySelectorAll('.inputCalc')]
    ...
    "g<sub>1</sub>": Number(arrayInputs[1].value),
    "g<sub>2</sub>": Number(arrayInputs[2].value),
    q: Number(arrayInputs[3].value),
    "&#936<sub>1</sub>": Number(arrayInputs[4].value),
    "&#936<sub>2</sub>": Number(arrayInputs[5].value),
